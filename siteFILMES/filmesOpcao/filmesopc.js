...
function filmes(botao) {
    
    let url = "https://api.themoviedb.org/3/discover/movie?language=pt-BR&with_genres=" + botao.value;
    ...
    for (let index = 0; index < todaLista.length; index++) {
        let urlItens = "https://media.themoviedb.org/t/p/w200";
        ...
        imgItem.src = urlItens + tiposFilmes.results[index].poster_path;
        nomeItem.textContent = tiposFilmes.results[index].title;
        descItem.textContent = tiposFilmes.results[index].overview.slice(0,200) + "...";
